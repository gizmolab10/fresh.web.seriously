import { T_Persistable, T_Database, T_Persistence } from '../common/Enumerations';
import { T_Thing, T_Trait, T_Create, T_Predicate } from '../common/Enumerations';
import { T_Debug, debug } from '../debug/Debug';
...
export default class DBAirtable extends DBCommon {
	...
	basePublic = new Airtable({ apiKey: this.personalAccessToken }).base(this.idBase);
